...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'stimuli/AcroViz_Black.png', 'path': 'stimuli/AcroViz_Black.png'},
    {'name': 'stimuli/redesign/largeiphone.png', 'path': 'stimuli/redesign/largeiphone.png'},
...
async function experimentInit() {
  ...
  i2_txt = new visual.TextStim({
    ...
    units: undefined, 
    pos: [0, 0.055], height: 0.067,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
  ...
  recall_txt_2 = new visual.TextStim({
    ...
    font: 'Arial',
    units: undefined, 
    pos: [0, 0.6], height: 0.075,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color([(- 0.6157), (- 0.6706), (- 0.0196)]),  opacity: undefined,
    depth: -3.0 
  });
...
function reset_RecallRoutineBegin(snapshot) {
  return async function () {
    ...
    reset_RecallComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Recall_touchRoutineBegin(snapshot) {
  return async function () {
    ...
    Recall_touchComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
